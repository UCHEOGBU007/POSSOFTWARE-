...
/**
 * BillingPage Component
 * Displays the merchant's current registered subscription details,
 * status warnings, and payment provider instructions.
 */
export default function BillingPage() {
  // Access global context hook for authentication state
        ...
        <div className="bg-pos-card border border-pos-border rounded-xl p-4 sm:p-6">
          ...
          {isTrial && (
            <div className="mt-4 flex items-start sm:items-center gap-3 p-3 rounded-lg bg-blue-500/10 border border-blue-500/20 text-sm text-blue-400">
              ...
              <span>
                Your Plan expires {formatDateShort(merchant.subscriptionExpiry)}
                . Contact support to keep access.
              </span>
            </div>
          )}
